...
import Gym2 from "../app/components/Gym2.jpg";
import Gym3 from "../app/components/Gym3.jpg";


//Class 4: Topics 
// Tailwind CSS
// How to make components and how to export them.
// How to make Nav Bar
    ...
    <h2 className="text-4xl font-semibold text-center">
        ...
        <div id="1">
          ...
          <div>
            <Image
              src={Gym2}
              className="md:h-[493px] h-full mt-10 md:mt-0  md:w-[800px] w-full ml-[250px] "
              alt="Gym"
            />
          </div>
          ...
          <div>
            <Image
              src={Gym3}
              className="md:h-[500px] h-full mt-10 md:mt-0  md:w-[500px] w-full ml-[400px] "
              alt="Gym3"
            />
          </div>
